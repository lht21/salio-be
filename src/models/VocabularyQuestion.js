...
const vocabularyQuestionSchema = new Schema({
    ...
    questions: {
        ...
        validate: {
            ...
            message: 'Vocabulary question bank chỉ hỗ trợ single_choice và short_answer'
        },
        default: []
    },
    level: {
...
vocabularyQuestionSchema.index({ vocabulary: 1 });
vocabularyQuestionSchema.index({ level: 1, tags: 1 });

export default mongoose.model('VocabularyQuestion', vocabularyQuestionSchema);
